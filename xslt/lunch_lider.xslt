                ...
                <div class="lider_div">
                    ...
                    <main class="main_center"> 
                        <div class="container">
                            ...
                            <div class="text_center">
                                ...
                                <ul>
                                    ...
                                    <li class="element"><xsl:value-of select="info/recept/six"/></li>
                                    <li class="element"><xsl:value-of select="info/recept/seven"/></li>
                                    <li class="element"><xsl:value-of select="info/recept/eight"/></li>
                                </ul>
                                </span>
                            </div>
                        </div>
                        <div class="preparation">
                            ...
                            <span class="text_info2">
                                <xsl:value-of select="info/recept/preparation3"/>
                            </span>
                            <span class="text_info2">
                                <xsl:value-of select="info/recept/preparation4"/>
                            </span>
                            <span class="end">
